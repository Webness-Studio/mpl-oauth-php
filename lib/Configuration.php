...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://sandbox.api.posta.hu/oauth2';
    ...
    {
        $report  = 'PHP SDK (WebnessStudio\MPL\OAuth) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://sandbox.api.posta.hu/oauth2",
                "description" => "Sandbox",
            ],
            [
                "url" => "https://core.api.posta.hu/oauth2",
